# Combat Legends Template

## Overview
A template for creating arena combat games with legendary fighters, combo systems, and competitive multiplayer modes.
...
4. Spectator modes and replay functionality
